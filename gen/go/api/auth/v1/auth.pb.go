...
func (x *LoginResponse) GetExpiresAt() int32 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
var file_api_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x32, 0x4d, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3e, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	0x19, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f,
...
var file_api_auth_v1_auth_proto_depIdxs = []int32{
	...
	1, // 1: api.auth.v1.AuthService.Login:output_type -> api.auth.v1.LoginResponse
