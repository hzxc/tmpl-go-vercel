...
func (c *pingPongClient) PingPong(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongResponse, error) {
...
func (UnimplementedPingPongServer) PingPong(context.Context, *PingRequest) (*PongResponse, error) {
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/pingpong/proto/pingpong.proto",
}
